defmodule Loom.Teams.Templates do
  @moduledoc """
  Persistent team templates — save and load team configurations from `.loom.toml`.
  ...
  Reads `[teams.templates.*]` sections from Loom.Config.
  """
  @spec list_templates() :: [t()]
  def list_templates do
    case Loom.Config.get(:teams) do
  ...
  This can be appended to `.loom.toml` to persist the template.
  """
