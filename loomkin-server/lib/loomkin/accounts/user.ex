defmodule Loomkin.Accounts.User do
  use Ecto.Schema
  ...
  @doc """
  A user changeset for registration that includes profile fields.
  """
  ...
  @doc """
  A user changeset for updating profile fields (username, display_name, avatar_url).
  """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Loomkin.Repo)
  ...
  defp validate_username(changeset, opts) do
    changeset =
      changeset
      |> validate_format(:username, ~r/^[a-z0-9]([a-z0-9_-]*[a-z0-9])?$/,
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:username, Loomkin.Repo)
  ...
  """
  def valid_password?(%Loomkin.Accounts.User{hashed_password: hashed_password}, password)
